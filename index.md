...
- 2025/08/14: M2 の大西君がフロリダ大学と共同で行った研究成果を，セキュリティのトップカンファレンス USENIX Security 2025 で発表しました．ラップトップなどに搭載されたディジタルマイクが意図せず発するノイズを，アンテナを用いて受信・復調すると，元の音声を復元できる新たな現象を発見しました．この脆弱性は，隣室から通話を盗聴する脅威を生じる可能性があります．
