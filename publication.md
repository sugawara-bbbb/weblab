...
1. 浅野多聞, 菅原健, "ALU内部のビット非独立なリーケージのシミュレーション評価," 2021年暗号と情報セキュリティシンポジウム(SCIS2021), 2D1-2, 8 pages, (Jan., 2021).
1. 高木翼, 李陽, 崎山一男, 菅原健, 梨本翔永, 鈴木大輔, "FPGAを用いた秘匿アクセラレーションの実装評価（II）," 2021年暗号と情報セキュリティシンポジウム(SCIS2021), 4D1-3, 7 pages, (Jan., 2021).
